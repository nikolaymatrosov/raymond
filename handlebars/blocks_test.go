...
var blocksTests = []Test{
	{
		...
		map[string]any{"goodbyes": []map[string]string{{"text": "goodbye"}, {"text": "Goodbye"}, {"text": "GOODBYE"}}, "world": "world"},
		nil, nil, nil,
	...
	},
	{
		...
		"{{#goodbyes}}{{text}}! {{/goodbyes}}cruel {{world}}!",
		map[string]any{"goodbyes": []map[string]string{}, "world": "world"},
		nil, nil, nil,
		"cruel world!",
	},
	{
	...
	},
	{
		...
		map[string]any{"goodbyes": []map[string]string{{"text": "goodbye"}, {"text": "Goodbye"}, {"text": "GOODBYE"}}, "name": "Alan"},
		nil, nil, nil,
...

	{
		...
		map[string]any{"omg": "OMG!", "outer": []map[string]any{{"sibling": "sad", "inner": []map[string]string{{"text": "goodbye"}}}}},
		nil, nil, nil,
...

	{
		...
		"{{#people}}{{name}}{{^}}{{none}}{{/people}}",
		map[string]any{"none": "No people", "people": map[string]any{}},
		nil, nil, nil,
		"No people",
	},
	{
	...
	// },
	{
		...
		"{{#outer}}Goodbye {{#inner}}cruel {{omg.yes}}{{/inner}}{{/outer}}",
		map[string]any{"omg": map[string]string{"no": "OMG!"}, "outer": []map[string]any{{"inner": []map[string]string{{"yes": "no", "text": "goodbye"}}}}},
		nil, nil, nil,
		"Goodbye cruel ",
	},
}
